...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "spectrum-seeder\n"
...
static const string mainnet_seeds[] = {"seed1.spectrum.cash", "seed2.spectrum.cash", ""};
static const string testnet_seeds[] = {"testnet-seed.spectrum.cash", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("149.28.57.142", 44820), true); 
    db.Add(CService("95.179.142.200", 44820), true);
  }
  do {
